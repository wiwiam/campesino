...
searchcambio(folioG,divisa,provision){                          
  ...
  loadOs(){
       ...
       this.dbs.collection("articulos").get().then(function(querySnapshot) {
          ...
          trd.innerHTML =`<td>`+ doc.data().fecha+`</td>`+`<td>`+ doc.data().codigo+`</td>`+`<td>`+ doc.data().descripcion+`</td>`+`<td style=" font-size: 20px;">`+ doc.data().publico+`</td>`+`<td>`+ doc.data().mayoreo+`</td>`+`<td>`+ doc.data().veinte+`</td>`+`<td>`+ doc.data().treinta+`</td>`+`<td>`+ doc.data().existencia+`</td>`+`<td><a class='btn  halfway-fab waves-effect waves-light red modal-trigger' href="#modal004" onclick="editararticulo(this);" ><i class='material-icons'>edit</i></a> </td>`+`<td><a class='btn  halfway-fab waves-effect waves-light blue modal-trigger' href="#modal006" onclick="verarticulo(this);" ><i class='material-icons'>remove_red_eye</i></a> </td>`;
   ...
   loadPedidos(){
       ...
       this.dbs.collection("pedidos").get().then(function(querySnapshot) {
          ...
          trd.innerHTML =`<td>`+ doc.data().fecha+`</td>`+`<td>`+ doc.data().folio+`</td>`+`<td>`+ doc.data().cliente+`</td>`+`<td>`+ doc.data().usuario+`</td>`+`<td>`+ doc.data().total+`</td>`+`</td>`+`<td><a class='btn  halfway-fab waves-effect waves-light red modal-trigger' href="#modal005" onclick="editararticulo(this);" ><i class='material-icons'>edit</i></a> </td>`;
