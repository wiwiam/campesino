...
var conDecimal = cadena.toFixed(2);
          trd.innerHTML =`<td>`+ doc.data().codigo+`</td>`+`<td>`+ doc.data().descripcion+`</td>`+`<td style=" font-size: 20px;">`+ doc.data().publico+`</td>`+`<td>`+ doc.data().mayoreo+`</td>`+`<td>`+ conDecimal+`</td>`  +`<td><a class='btn  halfway-fab waves-effect waves-light red modal-trigger' href="#modal004" onclick="editararticulo(this);" ><i class='material-icons'>edit</i></a> </td>`+`<td><a class='btn  halfway-fab waves-effect waves-light blue modal-trigger' href="#modal006" onclick="verarticulo(this);" ><i class='material-icons'>remove_red_eye</i></a> </td>`;
