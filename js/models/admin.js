...
searchcambio(folioG,divisa,provision){                          
  ...
  loadOs(){
       ...
       this.dbs.collection("articulos").get().then(function(querySnapshot) {
          ...
          trd.innerHTML =`<td>`+ doc.data().fecha+`</td>`+`<td>`+ doc.data().codigo+`</td>`+`<td>`+ doc.data().descripcion+`</td>`+`<td>`+ doc.data().distribuidor+`</td>`+`<td>`+ doc.data().publico+`</td>`+`<td>`+ doc.data().mayoreo+`</td>`+`<td>`+ doc.data().veinte+`</td>`+`<td>`+ doc.data().treinta+`</td>`+`<td>`+ doc.data().existencia+`</td>`+`<td>`+ doc.data().usuario+`</td>`+`<td><a class='btn  halfway-fab waves-effect waves-light red modal-trigger' href="#modal004" onclick="editararticulo(this);" ><i class='material-icons'>edit</i></a> </td>`;
